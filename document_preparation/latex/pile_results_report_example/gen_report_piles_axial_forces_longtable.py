...
logging.warning("This script uses LaTeX longtable package which doesn't work well with twocolumn. If you need to use twocolumn use supertabular instead.")
...
texFileName= './piles_axial_force_longtable.tex'
